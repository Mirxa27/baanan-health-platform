  ...
  const features = [
    {
      ...
      description: 'Advanced IoT-enabled devices for continuous health monitoring and real-time data collection with seamless integration.',
      color: 'blue',
    ...
    },
    {
      ...
      description: 'Intelligent posture monitoring systems with real-time feedback and personalized correction programs for better spinal health.',
      color: 'purple',
    ...
    },
    {
      ...
      description: 'Comprehensive wearable devices tracking vital signs, activity levels, and health metrics with 24/7 monitoring capabilities.',
      color: 'red',
    ...
    },
    {
      ...
      description: 'Machine learning-powered diagnostic systems providing accurate health assessments and predictive analytics for early intervention.',
      color: 'indigo',
    ...
    },
    {
      ...
      description: 'Comprehensive healthcare ecosystem connecting patients, providers, and devices for seamless care coordination.',
      color: 'teal',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4">
            Discover our comprehensive range of innovative healthcare technologies designed to transform patient care and improve health outcomes.
          </p>
        </div>
