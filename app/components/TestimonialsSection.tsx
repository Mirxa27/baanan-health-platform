  ...
  const testimonials = [
    {
      ...
      content: 'Baanan\'s integrated healthcare solutions have transformed how we deliver patient care. The AI analytics provide invaluable insights that help us make better treatment decisions.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The Halol app has streamlined our medical equipment procurement process. We can now manage everything from purchasing to maintenance in one platform - it\'s incredibly efficient.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Using Baanan\'s smart monitoring devices has improved our patient outcomes significantly. The real-time data and alerts help us provide better care around the clock.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The robotic physiotherapy systems from Baanan have revolutionized our rehabilitation programs. Patients recover faster and with more consistent results than ever before.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Baanan\'s consultancy services helped us optimize our healthcare operations. Their expertise in technology integration saved us both time and resources while improving patient satisfaction.',
      rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Hear from healthcare professionals and organizations who have transformed their operations with Baanan's innovative solutions.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-8 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl">
            ...
            <div className="text-sm text-gray-600 mt-2">Trust our solutions nationwide</div>
          </div>
          ...
          <div className="text-center p-8 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl">
            ...
            <div className="text-sm text-gray-600 mt-2">Improving lives every day</div>
          </div>
          ...
          <div className="text-center p-8 bg-gradient-to-br from-green-50 to-green-100 rounded-2xl">
            ...
            <div className="text-sm text-gray-600 mt-2">Consistently exceeding expectations</div>
          </div>
        </div>
      </div>
    </section>
