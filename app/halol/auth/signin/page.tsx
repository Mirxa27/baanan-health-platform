      ...
      <div className="max-w-md w-full space-y-8">
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <h3 className="text-sm font-medium text-yellow-800 mb-2">{t('dev_test_accounts')}</h3>
            <div className="text-xs text-yellow-700 space-y-1">
              <div>
                <strong>{t('admin')}:</strong> admin@halol.com / admin123
              </div>
              <div>
                <strong>{t('customer')}:</strong> customer@example.com / customer123
              </div>
              <div className="mt-2">
                <button
                  type="button"
